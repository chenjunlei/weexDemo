...
var _inside = __webpack_require__(251);

var _inside2 = _interopRequireDefault(_inside);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_inside2.default.el = '#root';
new Vue(_inside2.default);
...
__vue_options__.__file = "D:\\project\\weexDemo\\src\\inside.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0c1799fc"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  components: {
    ...
    WxcLotteryRain: _weexUi.WxcLotteryRain
  },
  data: function data() {
    return {
      images: ['https://img.alicdn.com/tfs/TB1sZPlb5IRMeJjy0FbXXbnqXXa-241-206.png', 'https://img.alicdn.com/tfs/TB1eCbwb3MPMeJjy1XcXXXpppXa-241-206.png', 'https://img.alicdn.com/tfs/TB1rDTjb3MPMeJjy1XdXXasrXXa-241-206.png', 'https://img.alicdn.com/tfs/TB1Nw2sb3MPMeJjy1XbXXcwxVXa-241-206.png', 'https://img.alicdn.com/tfs/TB1hCbwb3MPMeJjy1XcXXXpppXa-241-206.png'],
      config: {
        intervalTime: 450,
        hideAniTime: 300,
        showAniTime: 300,
  ...
  methods: {
    wxcLotteryRainCaught: function wxcLotteryRainCaught(e) {
      modal.toast({ 'message': '\u70B9\u4E2D\u5566\uFF01ID\uFF1A' + e.rainId, 'duration': 1 });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    slot: "middle"
  }, [_vm._v("卡尔特-内页")])]), _c('wxc-lottery-rain', {
    ref: "wxc-lottery-rain",
    staticClass: ["rainBox"],
    attrs: {
      "config": _vm.config,
      "picList": _vm.images,
      "wrapStyle": _vm.wrapStyle
    },
    on: {
      "wxcLotteryRainCaught": _vm.wxcLotteryRainCaught
    }
