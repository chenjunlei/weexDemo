...
__vue_options__.__file = "D:\\project\\weexDemo\\src\\index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
exports.default = {
  ...
  components: {
    ...
    WxcPageCalendar: _weexUi.WxcPageCalendar,
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "wxcButtonClicked": _vm.showCalendar
    }
  }), _c('wxc-button', {
    staticClass: ["btn"],
    attrs: {
    ...
    on: {
      "wxcButtonClicked": _vm.showReturnCalendar
    }
  }), _c('div', {
    staticClass: ["panel"]
  }, [(_vm.currentDate) ? _c('text', {
    staticClass: ["text"]
  }, [_vm._v("当前日期: " + _vm._s(_vm.currentDate))]) : _vm._e()]), _c('wxc-button', {
    staticClass: ["btn"],
    attrs: {
      "text": "幻灯片",
      "type": "red"
    ...
    on: {
      "wxcButtonClicked": _vm.openLightBox
    }
  }), _c('wxc-button', {
    staticClass: ["btn"],
    attrs: {
      "text": "测试Navigator跳转(体验下小游戏)",
      "type": "blue"
    },
    on: {
      "wxcButtonClicked": _vm.goPage
    }
  }), _c('wxc-button', {
    staticClass: ["btn"],
    attrs: {
